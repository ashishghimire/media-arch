<?php
    ...
    class AccessServiceProvider extends ServiceProvider
    {
        ...
        public function registerBindings()
        {
            ...
            $this->app->bind(
                \App\Repositories\Backend\Gallery\AlbumRepositoryInterface::class ,
                \App\Repositories\Backend\Gallery\EloquentAlbumRepository::class
            );
            $this->app->bind(
                \App\Repositories\Backend\Photo\PhotoRepositoryInterface::class ,
                \App\Repositories\Backend\Photo\EloquentPhotoRepository::class
            );
            $this->app->bind(
                \App\Repositories\Backend\File\FileRepositoryInterface::class ,
