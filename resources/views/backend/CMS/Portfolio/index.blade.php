  ...
  @section('content')
   ...
   <div class="box box-primary">
        ...
        Portfolio
            ...
            <a name="add" href="{!! url('admin/admin.portfolio/create') !!}"><i class="fa fa-plus-circle fa-2x"></i> </a>
      ...
      @foreach($data as $row)
                        ...
                        <tr>
                            ...
                            <td>{!! str_limit($row->description, 100) !!}</td>
                             <td>
                              <a href="{{url('/portfolio',$row->id)}}">
                                <img src="{!! url('uploads/'.$row->image)!!}" style="width:150px; height:150px;"></a>
                                <td>


                            <td>{!! link_to_route('admin.portfolio.edit', '', array($row->id),
                            array('class' => 'fa fa-pencil fa-fw','style'=>'float: left;
    ')) !!}
                                {!! Form::open(['method' => 'DELETE','route' => ['admin.portfolio.delete', $row->id]]) !!}
