  ...
  @section('content')
   ...
   <div class="box box-primary">
        ...
        About
            ...
            <a name="add" href="{!! url('admin/about/create') !!}"><i class="fa fa-plus-circle fa-2x"></i> </a>
...
<td> {!! link_to_route('admin.about.edit', '', array($row->id),


                                   array('class' => 'fa fa-pencil fa-fw','style'=>'float: left;
    ')) !!}
                                {!! Form::open(['method' => 'DELETE','route' => ['admin.about.delete', $row->id]]) !!}
