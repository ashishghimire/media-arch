  ...
  @section('content')
   ...
   <div class="box box-primary">
       ...
       Client
            ...
            <a name="add" href="{!! url('admin/photo/create') !!}"><i class="fa fa-plus-circle fa-2x"></i> </a>
      ...
      @foreach($data as $row)
                        ...
                        <tr>
                            ...
                            <td>{{$row->title}}</td>
                             ...
                             <td>
                              <a href="{{url('/photo',$row->id)}}">
                                <img src="{!! url('uploads/'.$row->image)!!}" style="width:150px; height:150px;"></a>
                                <td>


                            <td>{!! link_to_route('admin.photo.edit', '', array($row->id),
                            array('class' => 'fa fa-pencil fa-fw','style'=>'float: left;
    ')) !!}
                                {!! Form::open(['method' => 'DELETE','route' => ['admin.photo.delete', $row->id]]) !!}
