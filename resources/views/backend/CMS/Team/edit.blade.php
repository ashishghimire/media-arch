@extends('backend.layouts.app')
 ...
 <div class="col-md-8">
     ...
     <div class="box box-primary">
            ...
            <div class="box-body">
      {{ Form::model($data, ['route' => ['admin.team.update', $data], 'class' => 'form-horizontal', 'role' => 'form','files'=>'true' ,'method' => 'PATCH']) }}
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      ...
                      @if ($errors->has('description')) <p class="help-block">{{ $errors->first('descriotion') }}</p> @endif
